...
$(document).ready(function(){
	if($.browser.msie&&($.browser.version == '6.0' || $.browser.version == '7.0' || $.browser.version == '8.0' || $.browser.version == '9.0'))
		$("#style").attr("href","css/style_ie.css");
...
var highline={
	...
	,animation_:function(num){
		switch(num){
			case 1:
				$('#pc-two').addClass('animated fadeInDown');
				//$('#pc-two-c').addClass('animated fadeInUp');
				$('#pc-list-1').addClass('animated bounceIn');
				$('#pc-list-2').addClass('animated bounceIn');
				$('#pc-list-3').addClass('animated bounceIn');
				$('#pc-list-4').addClass('animated bounceIn');
				$('#pc-list-5').addClass('animated bounceIn');
				$('#pc-list-6').addClass('animated bounceIn');
				$('#pc-list-7').addClass('animated bounceIn');
                //移动
				$('#poe1-c').addClass('animated pulse');
			break;
			case 2:
				$('#pc-three').addClass('animated tada');
                //移动
			...
			case 3:
				//pc
				$('#pc-four').addClass('animated bounceInRight');
				$('#pc-four-c').addClass('animated fadeInUp');
                //移动
	...
	,animationBack:function(num){
		switch(num){
			case 1:
				...
				$('#poe1-c').addClass('animated fadeInDown');
			break;
			case 2:
			var time=200,time1=100;
			setTimeout(function(){ $("#cont2_img0").removeClass("img0_ani"); },time);	
			setTimeout(function(){ $("#cont2_img1").removeClass("img1_ani"); },time);	
			setTimeout(function(){ $("#cont2_img2").removeClass("img2_ani"); },time);	
			...
			setTimeout(function(){ $("#cont2_img6,#cont2_img7").removeClass("com_ani_scale_1"); },time1);	
			...
			var time=100;
			var time1=200;
			setTimeout(function(){ $("#cont3_img0").removeClass("img0_ani"); },time1);	
			setTimeout(function(){ $("#cont3_img1").removeClass("img1_ani"); },time);	
			setTimeout(function(){ $("#cont3_img2").removeClass("img2_ani"); },time);	
			setTimeout(function(){ $("#cont3_img3").removeClass("img3_ani"); },time);	
			$("#cont3_img4").removeClass("img4_ani");		
			$("#cont3_img5").removeClass("img5_ani");		
			setTimeout(function(){ $("#cont3_img6").removeClass("img6_ani"); },time);	
			setTimeout(function(){ $("#cont3_img7").removeClass("img7_ani"); },time);	
			...
			setTimeout(function(){ $("#cont4_img10").removeClass("img10_ani"); },time);	
			setTimeout(function(){ $("#cont4_img1").removeClass("img1_ani"); },time);	
			setTimeout(function(){ $("#cont4_img2").removeClass("img2_ani"); },time);	
			setTimeout(function(){ $("#cont4_img3").removeClass("img3_ani"); },time);	
			setTimeout(function(){ $("#cont4_img4").removeClass("img4_ani"); },time);	
			setTimeout(function(){ $("#cont4_img5").removeClass("img5_ani"); },time);	
